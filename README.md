# 🚀 Pusat Pemantauan Metrik Server & Dashboard Observabilitas Grafana-Prometheus
...
Stack observabilitas infrastruktur server terpadu menggabungkan Prometheus time-series database, Node Exporter metrik hardware, dan dashboard analitik visual Grafana.
...
```bash
git clone https://github.com/muhammadfikri-dev/grafana-prometheus-observability-stack.git
cd grafana-prometheus-observability-stack
```
